...
module.exports = {
  ...
  mutate: [
    "src/containers/tables/orders-table/components/orders-table-head/OrdersTableHead.tsx",
    "src/containers/tables/orders-table/components/orders-table-body/OrdersTableBody.tsx"
    // "src/**/*.ts?(x)",
    // "!src/**/index.ts?(x)",
    // "!src/**/selectors/*.ts?(x)",
